// Legacy frontend station rules.
// Backend station APIs are the source of truth for station eligibility,
// completion, and counts. Keep these helpers only as migration/offline fallbacks.
...
export function computeVisitedStationsCount(record) {
  ...
  for (const formKeys of Object.values(stationFormMap)) {
